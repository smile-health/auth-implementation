...
This article was last updated on 30 Apr 2025
...
This document aims to guide developers in implementing Keycloak within SMILE and help users understand the authentication flow, data synchronisation, and overall security mechanisms between the two systems. It is intended for developers, system architects, and administrators responsible for implementing, maintaining, or extending authentication within the SMILE ecosystem.

---

## Tables

Two tables, **SMILE** and **Keycloak**, are utilised for user authentication to validate that the user has the right privilege to access the system.
